...
<section id="gallery" class="gallery">
        <div class="container">
          ...
          <?php if ( $images ) : ?>
            <div class="gallery-grid" aria-label="<?php echo esc_attr( $heading ? $heading : 'Image gallery' ); ?>">
          ...
          <?php if ( $link ) : ?>
            ...
            <a
              class="btn btn-outline-dark btn-sharan gallery-instagram"
